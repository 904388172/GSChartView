...
@interface GSLineChartView ()<GSXAxisViewDelegate>

@property (nonatomic, strong) UIScrollView *scrollView;
@property (nonatomic, strong) GSXAxisView *xAxisView;
@property (nonatomic, strong) GSYAxisView *yAxisView;
@property (assign, nonatomic) CGFloat gap;
@end

@implementation GSLineChartView
...
//    self.chartViewFill = YES;
    ...
    // 添加x轴与y轴视图
    GSYAxisView *yAxisView = [[GSYAxisView alloc] init];
    [self addSubview:yAxisView];
    
    UIScrollView *scrollView = [[UIScrollView alloc] init];
    
    GSXAxisView *xAxisView = [[GSXAxisView alloc] init];
...
//    self.xAxisView.chartViewFill = self.isChartViewFill;
    ...
    self.xAxisView.showThePointNum = self.showThePointNum;
    self.xAxisView.showAllLabel = self.showAllLabel;
    [self.xAxisView draw];
...
- (void)xAxisView:(GSYAxisView *)xAxisView didClickButtonAtIndex:(NSInteger)index {
